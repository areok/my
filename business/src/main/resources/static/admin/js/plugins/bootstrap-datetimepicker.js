...
(function($) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function(element, options) {
      ...
      this.widget = $(getTemplate(this.timeIcon, options.pickDate, options.pickTime, options.pick12HourFormat, options.pickSeconds, options.collapse)).appendTo(this.$element);
        ...
        '<div class="bootstrap-datetimepicker-widget dropdown-menu">' +
          '<ul style="padding:0">' +
            '<li' + (collapse ? ' class="collapse in"' : '') + '>' +
              ...
              '</div>' +
            '</li>' +
            '<li class="picker-switch accordion-toggle"><a><span class="glyphicon '  + (timeIcon =='icon-time'? ' glyphicon-time':' glyphicon-calendar' )+ '"></span></a></li>' +
