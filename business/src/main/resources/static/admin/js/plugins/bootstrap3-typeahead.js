...
(function(root, factory) {
  ...
  * ================================= */
  ...
  , updater: function (item) {
	  //文本域赋值
	  this.$menu.prev().data('data-id', this.$menu.find('.active').attr('data-id'));
      return item;
    }
  ...
  , render: function (items) {
      ...
      items = $(items).map(function (i, item) {
        i = $(that.options.item).data('value', item.key);
        //赋值ID
        i.attr('data-id', item.value);
