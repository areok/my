 ...
 * http://generator.sturgeon.mopaas.com/reference/pluggingIn.html
 * Created by liuqing on 2016/12/30.
 */
public class MybatisJpaCommentGenerator implements CommentGenerator {
    /** The properties. */
     ...
     */
    public MybatisJpaCommentGenerator() {
        super();
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        for(IntrospectedColumn column:introspectedColumns){
            if(!column.isAutoIncrement()){//不自增 就使用UUID
        ...
        //add db
        topLevelClass.addJavaDocLine("@Entity(name=\""+introspectedTable.getFullyQualifiedTable()+"\")");
    }
    ...
    public void addFieldComment(Field field,
        ...
        field.addJavaDocLine(" * Database Column Default:"+defaultValue);
        ...
        if(introspectedTable.getPrimaryKeyColumns().contains(introspectedColumn)){//主键
            field.addJavaDocLine("@Id");
            field.addJavaDocLine("@Column(name = \""+introspectedColumn.getActualColumnName()+"\")");
            if(introspectedColumn.isAutoIncrement()){//自增
                field.addJavaDocLine("@GeneratedValue(strategy = GenerationType.IDENTITY)");
            }else{//UUID
                field.addJavaDocLine("@GenericGenerator(name=\"uuidGenerator\",strategy=\"uuid\")");
                field.addJavaDocLine("@GeneratedValue(generator=\"uuidGenerator\")");
            }
        }else{
            introspectedColumn.isGeneratedAlways();
            introspectedColumn.isGeneratedColumn();
            ...
            introspectedColumn.isJDBCDateColumn();
            introspectedColumn.isJdbcCharacterColumn();
            introspectedColumn.isJDBCTimeColumn();
